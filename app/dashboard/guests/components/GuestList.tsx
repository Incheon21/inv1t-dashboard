...
export function GuestList({ guests }: { guests: GuestWithWedding[] }) {
    ...
    const filteredGuests = guests.filter((guest) => {
        ...
        if (eventTypeFilter !== "ALL" && guest.eventType !== eventTypeFilter)
            return false;
            ...
            <div className="mb-4">
                <div className="relative">
                    <input
                        ...
                        className="w-full px-4 py-3 pl-11 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                    />
                    <svg
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                <div className="space-y-3 flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        {[
                            ...
                            {
                                value: "blessing-only",
                                label: "Pemberkatan Saja",
                            },
                            { value: "blessing-reception", label: "Keduanya" },
                            { value: "reception-only", label: "Resepsi Saja" },
                        ].map((type) => (
                            <button
                                key={type.value}
                                onClick={() => setEventTypeFilter(type.value)}
                                className={`px-3 sm:px-4 py-1.5 rounded-lg font-medium transition text-xs sm:text-sm ${
                                    eventTypeFilter === type.value
                                        ? type.value === "blessing-only"
                                            ? "bg-gray-900 text-white"
                                            : type.value ===
                                                "blessing-reception"
                                              ? "bg-gray-800 text-white"
                                              : type.value === "reception-only"
                ...
                {selectedGuests.length > 0 && (
                    <button
                        ...
                        className="px-4 sm:px-6 py-2 bg-gray-900 text-white rounded-lg font-medium hover:bg-gray-800 transition text-sm sm:text-base w-full sm:w-auto"
                    >
                                                ...
                                                {guest.phone && (
                                                    <div className="inline-flex items-center gap-1">
                                                        <a
                                                            ...
                                                            className="text-gray-900 hover:text-gray-700 hover:underline inline-flex items-center gap-1"
